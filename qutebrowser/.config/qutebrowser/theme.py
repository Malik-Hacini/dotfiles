...
def setup(c, samecolorrows=False):
    ...
    try:
        with colors_path.open("rb") as file:
            colors = defaults | tomllib.load(file)
    except (OSError, tomllib.TOMLDecodeError):
        colors = defaults

    palette = {
        "rosewater": colors["bright_foreground"],
        ...
        "sapphire": colors["bright_blue"],
        "blue": colors["bright_blue"],
        "lavender": colors["bright_magenta"],
        "text": colors["foreground"],
        "subtext1": colors["light_foreground"],
        "subtext0": colors["dark_foreground"],
        "overlay2": colors["muted"],
        "overlay1": colors["muted"],
        "overlay0": colors["muted"],
        "surface2": colors["selection"],
        "surface1": colors["lighter_background"],
        "surface0": colors["lighter_background"],
        "base": colors["background"],
        "mantle": colors["dark_background"],
        "crust": colors["darker_background"],
    }
